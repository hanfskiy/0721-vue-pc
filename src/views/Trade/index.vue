  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        <span
          :class="{
            username: true,
            selected: selectorAddressId === address.id,
          }"
          @click="selectorAddressId = address.id"
      ...
      <div class="detail">
        ...
        >
          <li style="width: 150px">
            <img :src="detail.imgUrl" style="width: 150px" />
          </li>
          <li>
            <p>
              {{ detail.skuName }}
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{ selectorAddress.userAddress }}</span>
        收货人：<span>{{ selectorAddress.consignee }}</span>
        <span>{{ selectorAddress.phoneNum }}</span>
      </div>
    </div>
...
export default {
  ...
  computed: {
    selectorAddress() {
      ...
      return userAddressList
        ? userAddressList.find((address) => address.id === selectorAddressId)
        : {};
    },
  },
  async mounted() {
    ...
    this.trade = trade;
    this.selectorAddressId = trade.userAddressList.find(
  ...
  methods: {
    async submit() {
      ...
      const { phoneNum, userAddress } = this.selectorAddress;
